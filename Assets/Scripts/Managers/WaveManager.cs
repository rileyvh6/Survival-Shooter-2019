...
public class WaveManager : MonoBehaviour
{
    ...
    IEnumerator StartNextWave()
    {
        ...
        number.text = "Round: " + (waveNumber + ((difficulty - 1) * waves.Count)).ToString();
            ...
            void Spawn(Wave.Entry entry)
    {
        ...
        Vector3 randomPosition = Random.insideUnitSphere * 400;
        randomPosition.y = 0;
    ...
    void CreateWaves()
    {
        ...
        Wave wave2 = new Wave();
        wave2.entries.Add(new Wave.Entry(enemies[0], 10 * difficulty));
        wave2.entries.Add(new Wave.Entry(enemies[1], 10 * difficulty));
        waves.Add(wave2);
        ...
        wave3.entries.Add(new Wave.Entry(enemies[2], 10 * difficulty));
        waves.Add(wave3);
        ...
        wave4.entries.Add(new Wave.Entry(enemies[2], 10 * difficulty));
        waves.Add(wave4);

        Wave wave5 = new Wave();
        wave5.entries.Add(new Wave.Entry(enemies[0], 20 * difficulty));
        wave5.entries.Add(new Wave.Entry(enemies[1], 20 * difficulty));
        wave5.entries.Add(new Wave.Entry(enemies[2], 10 * difficulty));
        wave5.entries.Add(new Wave.Entry(enemies[3], 3 * difficulty));
        waves.Add(wave5);

        Wave wave6 = new Wave();
        wave6.entries.Add(new Wave.Entry(enemies[4], 2 * difficulty));
        wave6.entries.Add(new Wave.Entry(enemies[3], 6 * difficulty));
        waves.Add(wave6);

        Wave wave7 = new Wave();
        wave7.entries.Add(new Wave.Entry(enemies[3], 6 * difficulty));
        wave7.entries.Add(new Wave.Entry(enemies[0], 20 * difficulty));
        wave7.entries.Add(new Wave.Entry(enemies[1], 20 * difficulty));
        wave7.entries.Add(new Wave.Entry(enemies[2], 10 * difficulty));
        waves.Add(wave7);

        Wave wave8 = new Wave();
        wave8.entries.Add(new Wave.Entry(enemies[0], 30 * difficulty));
        wave8.entries.Add(new Wave.Entry(enemies[1], 30 * difficulty));
        wave8.entries.Add(new Wave.Entry(enemies[2], 10 * difficulty));
        wave8.entries.Add(new Wave.Entry(enemies[3], 6 * difficulty));
        ...
        wave9.entries.Add(new Wave.Entry(enemies[2], 15 * difficulty));
        wave9.entries.Add(new Wave.Entry(enemies[3], 15 * difficulty));
        
        waves.Add(wave9);

        Wave wave10 = new Wave();
        wave10.entries.Add(new Wave.Entry(enemies[0], 50 * difficulty));
        wave10.entries.Add(new Wave.Entry(enemies[1], 10 * difficulty));
        wave10.entries.Add(new Wave.Entry(enemies[2], 50 * difficulty));
        wave10.entries.Add(new Wave.Entry(enemies[3], 15 * difficulty));
        wave10.entries.Add(new Wave.Entry(enemies[4], 1 * difficulty));
        waves.Add(wave10);

        Wave wave11 = new Wave();
        wave11.entries.Add(new Wave.Entry(enemies[0], 50 * difficulty));
        wave11.entries.Add(new Wave.Entry(enemies[1], 40 * difficulty));
        wave11.entries.Add(new Wave.Entry(enemies[2], 50 * difficulty));
        wave11.entries.Add(new Wave.Entry(enemies[3], 40 * difficulty));
        wave11.entries.Add(new Wave.Entry(enemies[4], 40 * difficulty));
        waves.Add(wave11);
