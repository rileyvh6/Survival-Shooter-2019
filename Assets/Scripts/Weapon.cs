/// There are 2 basic types of weapons that can be made with this script:
/// 
...
public class Weapon : MonoBehaviour
{
	...
	// Power
	public float power = 80.0f;							// The amount of power this weapon has (how much damage it can cause)
	public float forceMultiplier = 10.0f;				// Multiplier used to change the amount of force applied to rigid bodies that are shot
	
	
	// Range
	public float range = 9999.0f;						// How far this weapon can shoot
	...
	IEnumerator DelayFire()
	{
		...
		SendMessageUpwards("OnWeaponsFire", SendMessageOptions.DontRequireReceiver);
	...
	IEnumerator DelayLaunch()
	{
		...
		// Send a messsage so that users can do other actions whenever this happens
		SendMessageUpwards("OnWeaponsLaunch", SendMessageOptions.DontRequireReceiver);
...
//		}
	...
	void Reload()
	{
		...
		// Send a messsage so that users can do other actions whenever this happens
		SendMessageUpwards("OnWeaponsReload", SendMessageOptions.DontRequireReceiver);
	}
