...
public class HellephantAttack : MonoBehaviour
{
    ...
    void Attack()
    {
        ...
        if (bulletTimer > timeBetweenBullets && bulletCount < bulletsPerVolley)
        {
            ...
            Instantiate(bullet, projectileSpawnSpot.position, projectileSpawnSpot.rotation);
            //Instantiate(bullet, transform.position + new Vector3(0, 1.488f, 2.465f), rot);
	...
	//				Instantiate(bullet, transform.position + new Vector3(0, .25f, 0), rot);
	//			}
